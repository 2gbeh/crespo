  ...
  return (
    <>
      ...
      <SafeAreaView $padding={20}>
        ...
        <div className="flex gap-2.5 py-3 overflow-auto scrollbar-hide">
          {fakeMembers.slice(0, 10).map((e, i) => (
            <figure className="bg-red-100_  flex flex-col items-center min-w-12">
              <AvatarSolid key={i} text={MemberPipe.intials(e)} size={45} />
        ...
        {/* ALL */}
        <section className="mt-4 text-sm font-semibold">All members</section>
        <div className="flex flex-col gap-3 py-3 overflow-auto">
